...
#define	RL_META_MASK		    0x00100000ull
...
#define	RL_L_META_MASK   	    0x00000008ull
#define	RL_R_META_MASK   	    0x00000010ull
...
/* 
@param int Mac code
@returns ReLay code if existing, else returns Mac code
 */
int getCodeMacToRL(int macCode);

/*
@param int ReLay code
@returns Mac code
*/
